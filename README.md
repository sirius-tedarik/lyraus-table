...
| :------------------------ | :---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------: | -------: | -----------------------------------------------------------------------------------------: |
| **columns**               | An array of objects representing the columns of the table. Each object should contain key, label, and width properties. | [{ key: "orderNo", label: "Order No", width: 90 }] |    Array |                                                                                            |
...
| **currentPage**           | Current page number (optional).                                                                                         |                                                  1 |   Number |                                                                                            |
...
| **batchOperationsList**   | A list of options for batch operations (optional).                                                                      |                                                    | Function |                                                                                            |
...
| **alternateRowBg**        | Array of two Tailwind color classes for alternating row background colors(optional).                                    |                        ['bg-white', 'bg-gray-100'] |    Array |                                                                                            |
| **innerTable**            | An array representing the inner table columns (optional).                                                               | [{key: "vehicle",label: "Vehicle",width: "100px"}] |    Array |                                                                                            |
| **buttonsColumn**         | Configuration object for rendering custom buttons in a column (optional).                                               |                      { label: 'İşlem', width: 90 } |   Object |                                                                                            |
| **dropdownColumn**        | Configuration object for rendering dropdowns in a column (optional).                                                    |                      { label: 'Durum', width: 180} |   Object |                                                                                            |
...
| **containerClass**        | Tailwind class for the most outer div (optional).                                                                       |             flex justify-between items-center mb-6 |   string |                                                                                            |
| **operationsDiv**         | Tailwind class for the div containing batch operations and search bar (optional).                                       |                                          mx-2 mt-2 |   string |                                                     flex justify-between items-center mb-4 |
...
| **thClass**               | Tailwind class for table header cells (optional).                                                                       |                                                    |   string | py-3 text-left text-xs font-medium bg-gray-50 text-gray-500 tracking-wider border-gray-200 |
